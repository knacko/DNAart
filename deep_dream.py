...
#This deep dream script was pulled from: https://keras.io/examples/deep_dream/
...
# "mixed" & 'conv' layers supposedly produce the most interesting effects, with high-layer levels producing more complex patterns
...
#model.summary() #can use this to see all the layers that are available to play with
